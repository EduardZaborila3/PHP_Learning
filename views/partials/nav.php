            ...
            <div class="flex items-center">
                ...
                <div class="hidden md:block">
                    <div class="ml-10 flex items-baseline space-x-4">
                        ...
                        <a href="/" aria-current="page" class="<?= urlIs('/') ? 'bg-gray-900 text-white' : 'text-gray-300' ?> rounded-md text-gray-300 hover:bg-gray-700 px-3 py-2 text-sm font-medium">Home</a>
                        <a href="/about" class="<?= urlIs('/about') ? 'bg-gray-900 text-white' : 'text-gray-300' ?> hover:bg-gray-700 rounded-md px-3 py-2 text-sm font-medium hover:text-white">About</a>
                        <?php if ($_SESSION['user'] ?? false) : ?>
                            <a href="/notes" class="<?= urlIs('/notes') ? 'bg-gray-900 text-white' : 'text-gray-300' ?> hover:bg-gray-700 rounded-md px-3 py-2 text-sm font-medium hover:text-white">Notes</a>
                        <?php endif; ?>
                ...
                <div class="ml-4 flex items-center md:ml-6">
                    ...
                    <div class="relative ml-3">
                        <?php if ($_SESSION['user'] ?? false) : ?>
                            ...
                            <?php else : ?>
                                <a href="/register" class="<?= urlIs('/register') ? 'bg-gray-900 text-white' : 'text-gray-300' ?> hover:bg-gray-700 rounded-md px-3 py-2 text-sm font-medium hover:text-white">Register</a>
                                <a href="/login" class="<?= urlIs('/login') ? 'bg-gray-900 text-white' : 'text-gray-300' ?> hover:bg-gray-700 rounded-md px-3 py-2 text-sm font-medium hover:text-white">Log In</a>
                            <?php endif; ?>
                    </div>
                    <?php if ($_SESSION['user'] ?? false) : ?>
                        <div class="ml-3">
                            <form method="POST" action="/session">
                                ...
                                <button class="text-gray-300 text-sm">Log Out</button>
                            </form>
                        </div>
                    <?php endif; ?>
                </div>
